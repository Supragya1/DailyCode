...
void Push(int stack[],int size,int *top1,int data){
    if(*top1==size/2-1){
...
void Push2(int stack[],int size,int *top2,int data){
    if(*top2==size-1){
        printf("stack is full\n");
    }
    else {
...
int main(){
    ...
    scanf("%d",&size);
    int top1=-1,top2=size/2-1,data,n,num;
